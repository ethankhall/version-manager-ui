...
var UserService = (function () {
    function UserService(http, baseUrl, authService) {
        this.http = http;
        this.baseUrl = baseUrl;
        this.authService = authService;
    }
    UserService.prototype.getUserWatches = function () {
        ...
        return this.http.get(this.baseUrl.createFullUrl("/api/v1/user/watches"), { headers: headers })
            .toPromise()
            .then(function (request) { return request.json().watches.map(function (watch) { return watch.projectName; }); })
